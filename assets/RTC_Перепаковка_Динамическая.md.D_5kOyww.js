import{_ as a,c as n,o as i,ae as p}from"./chunks/framework.Cthp9TdA.js";const d=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"RTC/Перепаковка/Динамическая.md","filePath":"RTC/Перепаковка/Динамическая.md"}'),l={name:"RTC/Перепаковка/Динамическая.md"};function e(t,s,c,h,r,k){return i(),n("div",null,s[0]||(s[0]=[p(`<h3 id="динамическии-бинарник" tabindex="-1">Динамический бинарник <a class="header-anchor" href="#динамическии-бинарник" aria-label="Permalink to &quot;Динамический бинарник&quot;">​</a></h3><p>Для запуска x86-приложений на <a href="https://www.altlinux.org/Ports/e2k" title="Ports/e2k" target="_blank" rel="noreferrer">e2k</a> под <a href="https://www.altlinux.org/%D0%AD%D0%BB%D1%8C%D0%B1%D1%80%D1%83%D1%81/rtc" title="Эльбрус/rtc" target="_blank" rel="noreferrer">бинарным транслятором</a> необходимо подготовить окружение, достаточное для выполнения целевого приложения; в случае динамически скомпонованного исполняемого файла это обычно <a href="https://www.altlinux.org/Chroot" title="Chroot" target="_blank" rel="noreferrer">чрут</a> с нужными библиотеками</p><p>Для запуска нам нужен <code>statifier</code></p><div class="info custom-block"><p class="custom-block-title">Что такое <code>statifier</code></p><p>Это утилита, которая превращает динамически слинкованные исполняемые файлы в статически слинкованные.</p><p>То есть, она включает все необходимые библиотеки в один бинарник, который можно запускать без зависимости от системных библиотек.</p></div><p>Действия по упаковке:</p><div class="language-sh vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">sh</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># Установка утилиты для превращения динамических бинарников в статические</span></span>
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">apt-get</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> install</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -y</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> statifier</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># Монтируем /proc (нужно statifier&#39;у для анализа зависимостей)</span></span>
